...
# `ExtendedMixtureModel` is a generic distribution helper for extended
# likelihood fits. It is intentionally hidden in a separate file because it does
# not belong to this particular 2D model and is a candidate for eventual
# upstreaming to `DistributionsHEP.jl`.
