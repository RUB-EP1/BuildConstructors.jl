...
_phys === nothing && error(
    "PhysicsModelsExt did not activate. Load JSON, Distributions, NumericalDistributions, Polynomials, and SpecialFunctions before BuildConstructors.",
)
...
const Chebyshev = _phys.Chebyshev
